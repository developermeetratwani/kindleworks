  ...
  return (
    <nav className="nav" id="main-nav" style={transparent ? {} : { background: 'var(--kw-bg)' }}>
      ...
      <div className="nav__links">
        ...
        <button className="nav__link hero-morph-right" style={{ transitionDelay: '0.26s' }} onClick={() => scrollTo('features')}>Features</button>
        <button className="nav__link hero-morph-right" style={{ transitionDelay: '0.32s' }} onClick={() => scrollTo('pricing')}>Pricing</button>
        <button className="nav__link hero-morph-right" style={{ transitionDelay: '0.38s' }} onClick={() => scrollTo('contact')}>Contact</button>
        <Link to="/estimate" className="nav__link nav__link--accent hero-morph-right" style={{ transitionDelay: '0.46s' }}>Get Estimate</Link>
      </div>
